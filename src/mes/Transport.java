        ...
        else
        {
            ...
            */
            ...
            {  
                ...
                else if (blockToControl.getPosition().equals("0.5") && !(blockToControl.isDestination()) && entradaCelula==1)
                {
                    entradaCelula+=1;
                ...
                else if (blockToControl.getPosition().equals("0.7") && !(blockToControl.isDestination()) && entradaCelula==2)
                {
                    entradaCelula+=1;
                ...
                else if (blockToControl.getPosition().equals("0.10") && !(blockToControl.isDestination()) && entradaCelula==3)
                {
                    entradaCelula+=1;
                ...
                else if (blockToControl.getPosition().equals("0.12") && !(blockToControl.isDestination()) && entradaCelula==4)
                {
                    entradaCelula+=1;
